...
class OtherConnectionScreen extends StatefulWidget {
  const OtherConnectionScreen({Key? key}) : super(key: key);

  @override
  _OtherConnectionScreenState createState() => _OtherConnectionScreenState();
}

class _OtherConnectionScreenState extends State<OtherConnectionScreen> {
          ...
          child: Column(
            ...
            children: [
              Container(
                  ...
                  child: Utils.mediumHeadingNormalText(text:UtilStrings.Mutual_Connections+"(46)",textSize: 14,fontWeight: FontWeight.w700)),
              ...
              Container(
                  margin: EdgeInsets.only(left: 20),
                  child: Utils.mediumHeadingNormalText(text:UtilStrings.Other_Connections,textSize: 14,fontWeight: FontWeight.w700)),
              const SizedBox(height: 12,),
              ListView.builder(
                  shrinkWrap: true,
                  itemCount: 4,
                                  ...
                                  children: [
                                    SizedBox(
                                      ...
                                      child: Row(
                                        ...
                                        children: [
                                          const SizedBox(width: 10,),
                                          Utils.mediumHeadingNormalText(text:"Courtney",textSize: 14,fontWeight: FontWeight.w700),
                                          const Spacer(),
                                          SizedBox(
                                            height: 22,width: 22,
                                            child: PopupMenuButton(
                                    ...
                                    Container(
                                        margin: EdgeInsets.only(left: 10),
                                        child: Utils.mediumHeadingNormalText(text: "Product Designer at TESLA",textSize:10,color: Colors.grey)),
                                    SizedBox(height: 14,),
                                  ],
                                )
                              ],),
