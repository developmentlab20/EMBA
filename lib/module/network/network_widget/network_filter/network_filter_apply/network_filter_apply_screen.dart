...
class NetworkFilterApplyScreen extends StatefulWidget {
  const NetworkFilterApplyScreen({Key? key}) : super(key: key);

  @override
  State<NetworkFilterApplyScreen> createState() => _NetworkFilterApplyScreenState();
}

class _NetworkFilterApplyScreenState extends State<NetworkFilterApplyScreen> {
  bool CEO =true;
  bool CFO =false;
  bool MANAGERS =false;
  ...
  Widget build(BuildContext context) {
    ...
    return  Scaffold(
      ...
      appBar:  PreferredSize(
        ...
        child:CommonAppBar(title:UtilStrings.People,
        action: true,imageUrl: "filter.png",onTap: (){
                 ...
                 child: Column(
                   children: [
                     Container(height: 38,
                       ...
                       child: Row(
                         children: [
                           const Icon(Icons.close,color: AppColor.white,size: 16,),
                           const SizedBox(width: 6,),
                           Utils.mediumHeadingNormalText(text: "Real esta...",
                               textSize: 12,color: AppColor.white,fontWeight: FontWeight.w600
                           )
                         ],),
                     ),
                   ],
    ...
    showDialog(context: context, builder: (ctxt){
      return AlertDialog(
        shape: const RoundedRectangleBorder(
            borderRadius: BorderRadius.all(Radius.circular(12))),
        title:Column(children: [
          Utils.mediumHeadingNormalText(text:UtilStrings.Create_New_List,fontWeight: FontWeight.w700),
          const SizedBox(height: 16,),
          CommonTextField(hint: "List Name",controller: createNewListController,),
          const SizedBox(height: 16,),
          Utils.customDivider(),
          const SizedBox(height: 16,),
          Row(
            ...
            children: [
              GestureDetector(
                ...
                child: Container(height: 35,
                  ...
                  child: Center(
                    child: Utils.mediumHeadingNormalText(text: UtilStrings.Create,color: AppColor.white,textSize: 14,
                        fontWeight: FontWeight.w500),
                  ),
                ),
              ),
  ...
  createListValidation() {
    if(createNewListController.text.trim().toString().isEmpty){
