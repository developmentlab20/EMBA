...
class ArchivedChatScreen extends StatefulWidget {
  const ArchivedChatScreen({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar:  PreferredSize(
        ...
        child: CommonAppBar(title:"Archived Chats",action: true,onTap: (){
        },),),
      body:Column(
          ...
          Column(children: [
            ...
            GestureDetector(
              onTap: (){
                ...
                popDialog("ic_archived.png",UtilStrings.Are_you_sure_unarchive);
              },
              child: Row(children: [
                Utils.image(image: "ic_archived.png",height: 18,color: AppColor.grey),
                const SizedBox(width: 16,),
                Utils.mediumHeadingNormalText(text: UtilStrings.UnArchive_Chat,
